...
fn factor(unit: Unit) -> Rational {
    match unit {
        Unit::Centigram => from_fraction(1, 1),
        Unit::Decagram => from_fraction(1000, 1),
        Unit::Decigram => from_fraction(10, 1),
        Unit::Gram => from_fraction(100, 1),
        Unit::Hectogram => from_fraction(10000, 1),
        Unit::Kilogram => from_fraction(100000, 1),
        Unit::Microgram => from_fraction(1, 10000),
        Unit::Milligram => from_fraction(10000000000000001, 100000000000000000),
        Unit::Nanogram => from_fraction(19999999999999999, 200000000000000000000000),
        Unit::Ounce => from_fraction(28349523125000001, 10000000000000),
        Unit::Pound => from_fraction(45359237000000001, 1000000000000),
        Unit::Stone => from_fraction(63502931799999997, 100000000000),
        Unit::Ton => from_fraction(90718474, 1),
    }
}
