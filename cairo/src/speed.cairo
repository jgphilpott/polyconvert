...
fn factor(unit: Unit) -> Rational {
    match unit {
        Unit::CentimeterHour => from_fraction(1, 1),
        Unit::CentimeterMinute => from_fraction(60, 1),
        Unit::CentimeterSecond => from_fraction(3600, 1),
        Unit::FootHour => from_fraction(762, 25),
        Unit::FootMinute => from_fraction(9144, 5),
        Unit::FootSecond => from_fraction(109728, 1),
        Unit::InchHour => from_fraction(127, 50),
        Unit::InchMinute => from_fraction(15240000000000001, 100000000000000),
        Unit::InchSecond => from_fraction(9144, 1),
        Unit::KilometerHour => from_fraction(100000, 1),
        Unit::KilometerMinute => from_fraction(60000000000000009, 10000000000),
        Unit::KilometerSecond => from_fraction(360000000, 1),
        Unit::Knots => from_fraction(18520000000000003, 100000000000),
        Unit::MeterHour => from_fraction(100, 1),
        Unit::MeterMinute => from_fraction(6000, 1),
        Unit::MeterSecond => from_fraction(360000, 1),
        Unit::MileHour => from_fraction(16093439999999999, 100000000000),
        Unit::MileMinute => from_fraction(9656064, 1),
        Unit::MileSecond => from_fraction(579363840, 1),
        Unit::MillimeterHour => from_fraction(10000000000000001, 100000000000000000),
        Unit::MillimeterMinute => from_fraction(6, 1),
        Unit::MillimeterSecond => from_fraction(360, 1),
        Unit::YardHour => from_fraction(45719999999999999, 500000000000000),
        Unit::YardMinute => from_fraction(13715999999999999, 2500000000000),
        Unit::YardSecond => from_fraction(329184, 1),
    }
}
