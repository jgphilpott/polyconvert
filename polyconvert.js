...
convertData.bit.kilobyte = bit$kb = function(bit) {
  return bit / (8 * BYTES_PER_KIBIBYTE); // Bit to Kibibyte
};

convertData.bit.megabyte = bit$mb = function(bit) {
  return bit / (8 * BYTES_PER_MEBIBYTE); // Bit to Mebibyte
};

convertData.bit.gigabyte = bit$gb = function(bit) {
  return bit / (8 * BYTES_PER_GIBIBYTE); // Bit to Gibibyte
};

convertData.bit.terabyte = bit$tb = function(bit) {
  return bit / (8 * BYTES_PER_TEBIBYTE); // Bit to Tebibyte
};

convertData.bit.petabyte = bit$pb = function(bit) {
  return bit / (8 * BYTES_PER_PEBIBYTE); // Bit to Pebibyte
};

convertData.bit.exabyte = bit$eb = function(bit) {
  return bit / (8 * BYTES_PER_EXBIBYTE); // Bit to Exbibyte
};

convertData.bit.zettabyte = bit$zb = function(bit) {
  return bit / (8 * BYTES_PER_ZEBIBYTE); // Bit to Zebibyte
};

convertData.bit.yottabyte = bit$yb = function(bit) {
  return bit / (8 * BYTES_PER_YOBIBYTE); // Bit to Yobibyte
};
...
convertData.byte.kilobyte = byte$kb = function(byte) {
  return byte / BYTES_PER_KIBIBYTE; // Byte to Kibibyte
};

convertData.byte.megabyte = byte$mb = function(byte) {
  return byte / BYTES_PER_MEBIBYTE; // Byte to Mebibyte
};

convertData.byte.gigabyte = byte$gb = function(byte) {
  return byte / BYTES_PER_GIBIBYTE; // Byte to Gibibyte
};

convertData.byte.terabyte = byte$tb = function(byte) {
  return byte / BYTES_PER_TEBIBYTE; // Byte to Tebibyte
};

convertData.byte.petabyte = byte$pb = function(byte) {
  return byte / BYTES_PER_PEBIBYTE; // Byte to Pebibyte
};

convertData.byte.exabyte = byte$eb = function(byte) {
  return byte / BYTES_PER_EXBIBYTE; // Byte to Exbibyte
};

convertData.byte.zettabyte = byte$zb = function(byte) {
  return byte / BYTES_PER_ZEBIBYTE; // Byte to Zebibyte
};

convertData.byte.yottabyte = byte$yb = function(byte) {
  return byte / BYTES_PER_YOBIBYTE; // Byte to Yobibyte
};

/* Kibibyte Conversions */
convertData.kilobyte.bit = kb$bit = function(kb) {
  return kb * 8 * BYTES_PER_KIBIBYTE; // Kibibyte to Bit
};

convertData.kilobyte.byte = kb$byte = function(kb) {
  return kb * BYTES_PER_KIBIBYTE; // Kibibyte to Byte
};
...
convertData.kilobyte.gigabyte = kb$gb = function(kb) {
  return kb / BYTES_PER_MEBIBYTE; // Kibibyte to Gibibyte
};

convertData.kilobyte.terabyte = kb$tb = function(kb) {
  return kb / BYTES_PER_GIBIBYTE; // Kibibyte to Tebibyte
};

convertData.kilobyte.petabyte = kb$pb = function(kb) {
  return kb / BYTES_PER_TEBIBYTE; // Kibibyte to Pebibyte
};

convertData.kilobyte.exabyte = kb$eb = function(kb) {
  return kb / BYTES_PER_PEBIBYTE; // Kibibyte to Exbibyte
};

convertData.kilobyte.zettabyte = kb$zb = function(kb) {
  return kb / BYTES_PER_EXBIBYTE; // Kibibyte to Zebibyte
};

convertData.kilobyte.yottabyte = kb$yb = function(kb) {
  return kb / BYTES_PER_ZEBIBYTE; // Kibibyte to Yobibyte
};

/* Mebibyte Conversions */
convertData.megabyte.bit = mb$bit = function(mb) {
  return mb * 8 * BYTES_PER_MEBIBYTE; // Mebibyte to Bit
};

convertData.megabyte.byte = mb$byte = function(mb) {
  return mb * BYTES_PER_MEBIBYTE; // Mebibyte to Byte
};
...
convertData.megabyte.terabyte = mb$tb = function(mb) {
  return mb / BYTES_PER_MEBIBYTE; // Mebibyte to Tebibyte
};

convertData.megabyte.petabyte = mb$pb = function(mb) {
  return mb / BYTES_PER_GIBIBYTE; // Mebibyte to Pebibyte
};

convertData.megabyte.exabyte = mb$eb = function(mb) {
  return mb / BYTES_PER_TEBIBYTE; // Mebibyte to Exbibyte
};

convertData.megabyte.zettabyte = mb$zb = function(mb) {
  return mb / BYTES_PER_PEBIBYTE; // Mebibyte to Zebibyte
};

convertData.megabyte.yottabyte = mb$yb = function(mb) {
  return mb / BYTES_PER_EXBIBYTE; // Mebibyte to Yobibyte
};

/* Gibibyte Conversions */
convertData.gigabyte.bit = gb$bit = function(gb) {
  return gb * 8 * BYTES_PER_GIBIBYTE; // Gibibyte to Bit
};

convertData.gigabyte.byte = gb$byte = function(gb) {
  return gb * BYTES_PER_GIBIBYTE; // Gibibyte to Byte
};

convertData.gigabyte.kilobyte = gb$kb = function(gb) {
  return gb * BYTES_PER_MEBIBYTE; // Gibibyte to Kibibyte
};
...
convertData.gigabyte.petabyte = gb$pb = function(gb) {
  return gb / BYTES_PER_MEBIBYTE; // Gibibyte to Pebibyte
};

convertData.gigabyte.exabyte = gb$eb = function(gb) {
  return gb / BYTES_PER_GIBIBYTE; // Gibibyte to Exbibyte
};

convertData.gigabyte.zettabyte = gb$zb = function(gb) {
  return gb / BYTES_PER_TEBIBYTE; // Gibibyte to Zebibyte
};

convertData.gigabyte.yottabyte = gb$yb = function(gb) {
  return gb / BYTES_PER_PEBIBYTE; // Gibibyte to Yobibyte
};

/* Tebibyte Conversions */
convertData.terabyte.bit = tb$bit = function(tb) {
  return tb * 8 * BYTES_PER_TEBIBYTE; // Tebibyte to Bit
};

convertData.terabyte.byte = tb$byte = function(tb) {
  return tb * BYTES_PER_TEBIBYTE; // Tebibyte to Byte
};

convertData.terabyte.kilobyte = tb$kb = function(tb) {
  return tb * BYTES_PER_GIBIBYTE; // Tebibyte to Kibibyte
};

convertData.terabyte.megabyte = tb$mb = function(tb) {
  return tb * BYTES_PER_MEBIBYTE; // Tebibyte to Mebibyte
};
...
convertData.terabyte.exabyte = tb$eb = function(tb) {
  return tb / BYTES_PER_MEBIBYTE; // Tebibyte to Exbibyte
};

convertData.terabyte.zettabyte = tb$zb = function(tb) {
  return tb / BYTES_PER_GIBIBYTE; // Tebibyte to Zebibyte
};

convertData.terabyte.yottabyte = tb$yb = function(tb) {
  return tb / BYTES_PER_TEBIBYTE; // Tebibyte to Yobibyte
};

/* Pebibyte Conversions */
convertData.petabyte.bit = pb$bit = function(pb) {
  return pb * 8 * BYTES_PER_PEBIBYTE; // Pebibyte to Bit
};

convertData.petabyte.byte = pb$byte = function(pb) {
  return pb * BYTES_PER_PEBIBYTE; // Pebibyte to Byte
};

convertData.petabyte.kilobyte = pb$kb = function(pb) {
  return pb * BYTES_PER_TEBIBYTE; // Pebibyte to Kibibyte
};

convertData.petabyte.megabyte = pb$mb = function(pb) {
  return pb * BYTES_PER_GIBIBYTE; // Pebibyte to Mebibyte
};

convertData.petabyte.gigabyte = pb$gb = function(pb) {
  return pb * BYTES_PER_MEBIBYTE; // Pebibyte to Gibibyte
};
...
convertData.petabyte.zettabyte = pb$zb = function(pb) {
  return pb / BYTES_PER_MEBIBYTE; // Pebibyte to Zebibyte
};

convertData.petabyte.yottabyte = pb$yb = function(pb) {
  return pb / BYTES_PER_GIBIBYTE; // Pebibyte to Yobibyte
};

/* Exbibyte Conversions */
convertData.exabyte.bit = eb$bit = function(eb) {
  return eb * 8 * BYTES_PER_EXBIBYTE; // Exbibyte to Bit
};

convertData.exabyte.byte = eb$byte = function(eb) {
  return eb * BYTES_PER_EXBIBYTE; // Exbibyte to Byte
};

convertData.exabyte.kilobyte = eb$kb = function(eb) {
  return eb * BYTES_PER_PEBIBYTE; // Exbibyte to Kibibyte
};

convertData.exabyte.megabyte = eb$mb = function(eb) {
  return eb * BYTES_PER_TEBIBYTE; // Exbibyte to Mebibyte
};

convertData.exabyte.gigabyte = eb$gb = function(eb) {
  return eb * BYTES_PER_GIBIBYTE; // Exbibyte to Gibibyte
};

convertData.exabyte.terabyte = eb$tb = function(eb) {
  return eb * BYTES_PER_MEBIBYTE; // Exbibyte to Tebibyte
};
...
convertData.exabyte.yottabyte = eb$yb = function(eb) {
  return eb / BYTES_PER_MEBIBYTE; // Exbibyte to Yobibyte
};

/* Zebibyte Conversions */
convertData.zettabyte.bit = zb$bit = function(zb) {
  return zb * 8 * BYTES_PER_ZEBIBYTE; // Zebibyte to Bit
};

convertData.zettabyte.byte = zb$byte = function(zb) {
  return zb * BYTES_PER_ZEBIBYTE; // Zebibyte to Byte
};

convertData.zettabyte.kilobyte = zb$kb = function(zb) {
  return zb * BYTES_PER_EXBIBYTE; // Zebibyte to Kibibyte
};

convertData.zettabyte.megabyte = zb$mb = function(zb) {
  return zb * BYTES_PER_PEBIBYTE; // Zebibyte to Mebibyte
};

convertData.zettabyte.gigabyte = zb$gb = function(zb) {
  return zb * BYTES_PER_TEBIBYTE; // Zebibyte to Gibibyte
};

convertData.zettabyte.terabyte = zb$tb = function(zb) {
  return zb * BYTES_PER_GIBIBYTE; // Zebibyte to Tebibyte
};

convertData.zettabyte.petabyte = zb$pb = function(zb) {
  return zb * BYTES_PER_MEBIBYTE; // Zebibyte to Pebibyte
};
...
convertData.yottabyte.bit = yb$bit = function(yb) {
  return yb * 8 * BYTES_PER_YOBIBYTE; // Yobibyte to Bit
};

convertData.yottabyte.byte = yb$byte = function(yb) {
  return yb * BYTES_PER_YOBIBYTE; // Yobibyte to Byte
};

convertData.yottabyte.kilobyte = yb$kb = function(yb) {
  return yb * BYTES_PER_ZEBIBYTE; // Yobibyte to Kibibyte
};

convertData.yottabyte.megabyte = yb$mb = function(yb) {
  return yb * BYTES_PER_EXBIBYTE; // Yobibyte to Mebibyte
};

convertData.yottabyte.gigabyte = yb$gb = function(yb) {
  return yb * BYTES_PER_PEBIBYTE; // Yobibyte to Gibibyte
};

convertData.yottabyte.terabyte = yb$tb = function(yb) {
  return yb * BYTES_PER_TEBIBYTE; // Yobibyte to Tebibyte
};

convertData.yottabyte.petabyte = yb$pb = function(yb) {
  return yb * BYTES_PER_GIBIBYTE; // Yobibyte to Pebibyte
};

convertData.yottabyte.exabyte = yb$eb = function(yb) {
  return yb * BYTES_PER_MEBIBYTE; // Yobibyte to Exbibyte
};
...
convertEnergy.joule.wattHour = j$wh = function(j) {
  return j / 3600; // Joule to Watt-hour
};

convertEnergy.joule.kilowattHour = j$kwh = function(j) {
  return j / 3.6e+6; // Joule to Kilowatt-hour
};

convertEnergy.joule.electronvolt = j$ev = function(j) {
  return j / 1.602176634e-19; // Joule to Electronvolt
};

convertEnergy.joule.calorie = j$cal = function(j) {
  return j / 4.184; // Joule to Calorie (thermodynamic)
};

convertEnergy.joule.kilocalorie = j$kcal = function(j) {
  return j / 4184; // Joule to Kilocalorie
};

convertEnergy.joule.btu = j$btu = function(j) {
  return j / 1055.05585; // Joule to BTU (IT)
};

convertEnergy.joule.footPound = j$ftlb = function(j) {
  return j / 1.3558179483314004; // Joule to Foot-pound
};
...
convertEnergy.kilojoule.wattHour = kj$wh = function(kj) {
  return kj * 1e+3 / 3600; // Kilojoule to Watt-hour
};
...
convertEnergy.kilojoule.electronvolt = kj$ev = function(kj) {
  return kj * 1e+3 / 1.602176634e-19; // Kilojoule to Electronvolt
};

convertEnergy.kilojoule.calorie = kj$cal = function(kj) {
  return kj * 1e+3 / 4.184; // Kilojoule to Calorie
};

convertEnergy.kilojoule.kilocalorie = kj$kcal = function(kj) {
  return kj * 1e+3 / 4184; // Kilojoule to Kilocalorie
};

convertEnergy.kilojoule.btu = kj$btu = function(kj) {
  return kj * 1e+3 / 1055.05585; // Kilojoule to BTU
};

convertEnergy.kilojoule.footPound = kj$ftlb = function(kj) {
  return kj * 1e+3 / 1.3558179483314004; // Kilojoule to Foot-pound
};
...
convertEnergy.watt.watt = w$w = function(w) {
  return w; // Watt to Watt
};

convertEnergy.watt.kilowatt = w$kw = function(w) {
...
convertEnergy.kilowatt.kilowatt = kw$kw = function(kw) {
  return kw; // Kilowatt to Kilowatt
};

convertEnergy.kilowatt.watt = kw$w = function(kw) {
...
convertEnergy.wattHour.joule = wh$j = function(wh) {
  return wh * 3600; // Watt-hour to Joule
};

convertEnergy.wattHour.kilojoule = wh$kj = function(wh) {
  return wh * 3.6; // Watt-hour to Kilojoule
};

convertEnergy.wattHour.wattHour = wh$wh = function(wh) {
  return wh; // Watt-hour to Watt-hour
};

convertEnergy.wattHour.kilowattHour = wh$kwh = function(wh) {
  return wh / 1e+3; // Watt-hour to Kilowatt-hour
};

convertEnergy.wattHour.electronvolt = wh$ev = function(wh) {
  return wh * 3600 / 1.602176634e-19; // Watt-hour to Electronvolt
};

convertEnergy.wattHour.calorie = wh$cal = function(wh) {
  return wh * 3600 / 4.184; // Watt-hour to Calorie
};

convertEnergy.wattHour.kilocalorie = wh$kcal = function(wh) {
  return wh * 3600 / 4184; // Watt-hour to Kilocalorie
};

convertEnergy.wattHour.btu = wh$btu = function(wh) {
  return wh * 3600 / 1055.05585; // Watt-hour to BTU
};

convertEnergy.wattHour.footPound = wh$ftlb = function(wh) {
  return wh * 3600 / 1.3558179483314004; // Watt-hour to Foot-pound
};

/* Kilowatt-hour Conversions */
convertEnergy.kilowattHour.joule = kwh$j = function(kwh) {
  return kwh * 3.6e+6; // Kilowatt-hour to Joule
};
...
convertEnergy.kilowattHour.wattHour = kwh$wh = function(kwh) {
  return kwh * 1e+3; // Kilowatt-hour to Watt-hour
};

convertEnergy.kilowattHour.kilowattHour = kwh$kwh = function(kwh) {
  return kwh; // Kilowatt-hour to Kilowatt-hour
};

convertEnergy.kilowattHour.electronvolt = kwh$ev = function(kwh) {
  return kwh * 3.6e+6 / 1.602176634e-19; // Kilowatt-hour to Electronvolt
};

convertEnergy.kilowattHour.calorie = kwh$cal = function(kwh) {
  return kwh * 3.6e+6 / 4.184; // Kilowatt-hour to Calorie
};

convertEnergy.kilowattHour.kilocalorie = kwh$kcal = function(kwh) {
  return kwh * 3.6e+6 / 4184; // Kilowatt-hour to Kilocalorie
};

convertEnergy.kilowattHour.btu = kwh$btu = function(kwh) {
  return kwh * 3.6e+6 / 1055.05585; // Kilowatt-hour to BTU
};

convertEnergy.kilowattHour.footPound = kwh$ftlb = function(kwh) {
  return kwh * 3.6e+6 / 1.3558179483314004; // Kilowatt-hour to Foot-pound
};

/* Electronvolt Conversions */
convertEnergy.electronvolt.joule = ev$j = function(ev) {
  return ev * 1.602176634e-19; // Electronvolt to Joule
};

convertEnergy.electronvolt.kilojoule = ev$kj = function(ev) {
  return ev * 1.602176634e-19 / 1e+3; // Electronvolt to Kilojoule
};

convertEnergy.electronvolt.wattHour = ev$wh = function(ev) {
  return ev * 1.602176634e-19 / 3600; // Electronvolt to Watt-hour
};

convertEnergy.electronvolt.kilowattHour = ev$kwh = function(ev) {
  return ev * 1.602176634e-19 / 3.6e+6; // Electronvolt to Kilowatt-hour
};

convertEnergy.electronvolt.electronvolt = ev$ev = function(ev) {
  return ev; // Electronvolt to Electronvolt
};

convertEnergy.electronvolt.calorie = ev$cal = function(ev) {
  return ev * 1.602176634e-19 / 4.184; // Electronvolt to Calorie
};

convertEnergy.electronvolt.kilocalorie = ev$kcal = function(ev) {
  return ev * 1.602176634e-19 / 4184; // Electronvolt to Kilocalorie
};

convertEnergy.electronvolt.btu = ev$btu = function(ev) {
  return ev * 1.602176634e-19 / 1055.05585; // Electronvolt to BTU
};

convertEnergy.electronvolt.footPound = ev$ftlb = function(ev) {
  return ev * 1.602176634e-19 / 1.3558179483314004; // Electronvolt to Foot-pound
};

/* Calorie Conversions */
convertEnergy.calorie.joule = cal$j = function(cal) {
  return cal * 4.184; // Calorie to Joule
};

convertEnergy.calorie.kilojoule = cal$kj = function(cal) {
  return cal * 4.184 / 1e+3; // Calorie to Kilojoule
};

convertEnergy.calorie.wattHour = cal$wh = function(cal) {
  return cal * 4.184 / 3600; // Calorie to Watt-hour
};

convertEnergy.calorie.kilowattHour = cal$kwh = function(cal) {
  return cal * 4.184 / 3.6e+6; // Calorie to Kilowatt-hour
};

convertEnergy.calorie.electronvolt = cal$ev = function(cal) {
  return cal * 4.184 / 1.602176634e-19; // Calorie to Electronvolt
};

convertEnergy.calorie.calorie = cal$cal = function(cal) {
  return cal; // Calorie to Calorie
};

convertEnergy.calorie.kilocalorie = cal$kcal = function(cal) {
  return cal / 1e+3; // Calorie to Kilocalorie
};

convertEnergy.calorie.btu = cal$btu = function(cal) {
  return cal * 4.184 / 1055.05585; // Calorie to BTU
};

convertEnergy.calorie.footPound = cal$ftlb = function(cal) {
  return cal * 4.184 / 1.3558179483314004; // Calorie to Foot-pound
};

/* Kilocalorie Conversions */
convertEnergy.kilocalorie.joule = kcal$j = function(kcal) {
  return kcal * 4184; // Kilocalorie to Joule
};

convertEnergy.kilocalorie.kilojoule = kcal$kj = function(kcal) {
  return kcal * 4.184; // Kilocalorie to Kilojoule
};

convertEnergy.kilocalorie.wattHour = kcal$wh = function(kcal) {
  return kcal * 4184 / 3600; // Kilocalorie to Watt-hour
};

convertEnergy.kilocalorie.kilowattHour = kcal$kwh = function(kcal) {
  return kcal * 4184 / 3.6e+6; // Kilocalorie to Kilowatt-hour
};

convertEnergy.kilocalorie.electronvolt = kcal$ev = function(kcal) {
  return kcal * 4184 / 1.602176634e-19; // Kilocalorie to Electronvolt
};

convertEnergy.kilocalorie.calorie = kcal$cal = function(kcal) {
  return kcal * 1e+3; // Kilocalorie to Calorie
};

convertEnergy.kilocalorie.kilocalorie = kcal$kcal = function(kcal) {
  return kcal; // Kilocalorie to Kilocalorie
};

convertEnergy.kilocalorie.btu = kcal$btu = function(kcal) {
  return kcal * 4184 / 1055.05585; // Kilocalorie to BTU
};

convertEnergy.kilocalorie.footPound = kcal$ftlb = function(kcal) {
  return kcal * 4184 / 1.3558179483314004; // Kilocalorie to Foot-pound
};

/* BTU Conversions */
convertEnergy.btu.joule = btu$j = function(btu) {
  return btu * 1055.05585; // BTU to Joule
};

convertEnergy.btu.kilojoule = btu$kj = function(btu) {
  return btu * 1.05505585; // BTU to Kilojoule
};

convertEnergy.btu.wattHour = btu$wh = function(btu) {
  return btu * 1055.05585 / 3600; // BTU to Watt-hour
};

convertEnergy.btu.kilowattHour = btu$kwh = function(btu) {
  return btu * 1055.05585 / 3.6e+6; // BTU to Kilowatt-hour
};

convertEnergy.btu.electronvolt = btu$ev = function(btu) {
  return btu * 1055.05585 / 1.602176634e-19; // BTU to Electronvolt
};

convertEnergy.btu.calorie = btu$cal = function(btu) {
  return btu * 1055.05585 / 4.184; // BTU to Calorie
};

convertEnergy.btu.kilocalorie = btu$kcal = function(btu) {
  return btu * 1055.05585 / 4184; // BTU to Kilocalorie
};

convertEnergy.btu.btu = btu$btu = function(btu) {
  return btu; // BTU to BTU
};

convertEnergy.btu.footPound = btu$ftlb = function(btu) {
  return btu * 1055.05585 / 1.3558179483314004; // BTU to Foot-pound
};

/* Foot-pound Conversions */
convertEnergy.footPound.joule = ftlb$j = function(ftlb) {
  return ftlb * 1.3558179483314004; // Foot-pound to Joule
};

convertEnergy.footPound.kilojoule = ftlb$kj = function(ftlb) {
  return ftlb * 1.3558179483314004 / 1e+3; // Foot-pound to Kilojoule
};

convertEnergy.footPound.wattHour = ftlb$wh = function(ftlb) {
  return ftlb * 1.3558179483314004 / 3600; // Foot-pound to Watt-hour
};

convertEnergy.footPound.kilowattHour = ftlb$kwh = function(ftlb) {
  return ftlb * 1.3558179483314004 / 3.6e+6; // Foot-pound to Kilowatt-hour
};

convertEnergy.footPound.electronvolt = ftlb$ev = function(ftlb) {
  return ftlb * 1.3558179483314004 / 1.602176634e-19; // Foot-pound to Electronvolt
};

convertEnergy.footPound.calorie = ftlb$cal = function(ftlb) {
  return ftlb * 1.3558179483314004 / 4.184; // Foot-pound to Calorie
};

convertEnergy.footPound.kilocalorie = ftlb$kcal = function(ftlb) {
  return ftlb * 1.3558179483314004 / 4184; // Foot-pound to Kilocalorie
};

convertEnergy.footPound.btu = ftlb$btu = function(ftlb) {
  return ftlb * 1.3558179483314004 / 1055.05585; // Foot-pound to BTU
};

convertEnergy.footPound.footPound = ftlb$ftlb = function(ftlb) {
  return ftlb; // Foot-pound to Foot-pound
};
...
speedDefs = [
  {
    key: 'millimeterSecond',
    dist: 0.001,
    time: 1
  },
  {
    key: 'millimeterMinute',
    dist: 0.001,
    time: 60
  },
  {
  ...
  {
    key: 'centimeterSecond',
    dist: 0.01,
    time: 1
  },
  {
    key: 'centimeterMinute',
    dist: 0.01,
    time: 60
  },
  {
...
for (i = 0, len = speedDefs.length; i < len; i++) {
  def = speedDefs[i];
  convertSpeed[def.key] = {};
}

for (n = 0, len1 = speedDefs.length; n < len1; n++) {
  fromDef = speedDefs[n];
  for (o = 0, len2 = speedDefs.length; o < len2; o++) {
    toDef = speedDefs[o];
    (function(fromDef, toDef) {
      return convertSpeed[fromDef.key][toDef.key] = function(v) {
