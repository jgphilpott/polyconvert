...
fn factor(unit: Unit) -> Rational {
    match unit {
        Unit::Centigray => from_fraction(1, 1),
        Unit::Decagray => from_fraction(1000, 1),
        Unit::Decigray => from_fraction(10, 1),
        Unit::Exagray => from_fraction(100000000000000000000, 1),
        Unit::Gigagray => from_fraction(100000000000, 1),
        Unit::Gray => from_fraction(100, 1),
        Unit::Hectogray => from_fraction(10000, 1),
        Unit::Kilogray => from_fraction(100000, 1),
        Unit::Megagray => from_fraction(100000000, 1),
        Unit::Microgray => from_fraction(1, 10000),
        Unit::Milligray => from_fraction(10000000000000001, 100000000000000000),
        Unit::Nanogray => from_fraction(19999999999999999, 200000000000000000000000),
        Unit::Petagray => from_fraction(100000000000000000, 1),
        Unit::Teragray => from_fraction(100000000000000, 1),
    }
}
